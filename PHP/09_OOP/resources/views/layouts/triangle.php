...
<body>
    ...
    <main>
        ...
        <form action="../../../app/controllers/receive_data.php" method="GET">
            ...
            <br />
            <br />
            <input type="number" id="base" name="base" placeholder="Base del triángulo">
            <br />
            <br />
            <input type="number" id="height" name="height" placeholder="Alto del triángulo">
            <br />
            <br />
            <input type="submit" value="Calcular" />
            <input type="hidden" name="figure" value="triangle" />
        </form>
